...
let soundfiles = fs.readFileSync("./outsoundfiles.txt").toString().split("\n").sort();
let date = new Date();
...
let _abstract = `comprehensve sound file index: sound threads & weavings created from recorded fragments. experiments in generative command line sox audio sequences`;
