...
const prefix = "thread048";
const instrument = "bagpipegeese";
const rawsoundfiles = ["bagpipe1a", "bagpipegeese", "bagpiperadio"];
...
threadp.push( 
  ( ( id, harmonicweights ) => {
    ...
    return { id, notes };
  } ) ("harmonic", { lowi: 0, bassi: 1, bassV: 2, bassIV: 2, I: 6, II: 5, majIII: 1, miniii: 5, IV: 9, V: 9, VI: 4, majVII: 1, minvii: 4, VIII: 2, lownoise: 0, midnoise: 0, highnoise: 0, noise:0, buzz: 0 })
);
...
threadp.push( 
  ( ( id, harmonicweights ) => {
    ...
    let notes = tools.reifyWeightedArray( Object.entries(weights).map( w=>{ return [w[0],Math.floor(w[1])] } ) );
    return { id, notes };
  } ) ("simple", { lowi: 0, bassi: 1, bassV: 3, bassIV: 3, I: 6, II: 0, majIII: 0, miniii: 0, IV: 6, V: 6, VI: 0, majVII: 0, minvii: 0, VIII: 2, lownoise: 0, midnoise: 0, highnoise: 0, noise:0, buzz: 0 })
);
