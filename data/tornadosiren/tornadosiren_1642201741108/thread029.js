...
const prefix = "thread029";
const instrument = "tornadosiren";
const rawsoundfiles = ["tornadosiren", "tornadosiren2", "clarinetnotes_e", "clarinet1"];
...
threadp.push( 
  ( ( id, harmonicweights ) => {
    ...
    let notes = tools.reifyWeightedArray( Object.entries(weights).map( w=>{ return [w[0],Math.floor(w[1])] } ) );
    return { id, notes };
  } ) ("pentatonic", { lowi: 1, bassi: 1, bassV: 6, bassIV: 6, I: 6, II: 0, majIII: 0, miniii: 6, IV: 6, V: 6, VI: 0, majVII: 0, minvii: 3, VIII: 2, lownoise: 1, midnoise: 1, highnoise: 0, noise:0, buzz: 0 })
);
...
threadp.push( 
  ( ( id, harmonicweights ) => {
    ...
    let notes = tools.reifyWeightedArray( Object.entries(weights).map( w=>{ return [w[0],Math.floor(w[1])] } ) );
    return { id, notes };
  } ) ("pentatonic2", { lowi: 1, bassi: 2, bassV: 6, bassIV: 6, I: 6, II: 3, majIII: 0, miniii: 0, IV: 6, V: 6, VI: 6, majVII: 0, minvii: 0, VIII: 1, lownoise: 1, midnoise: 1, highnoise: 0, noise:0, buzz: 0 })
);
