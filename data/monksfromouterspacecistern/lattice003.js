...
const prefix = "lattice003";
const instrument = "monksfromouterspace";
...
const toneweights = [
  { lowi: 0, bassi: 1, bassV: 1, bassIV: 1, I: 6, II: 0, majIII: 0, miniii: 1, IV: 0, V: 1, VI: 0, majVII: 0, minvii: 0, VIII: 0, lownoise: 0, midnoise: 1, highnoise: 0, noise:0, buzz: 0 },
  { lowi: 0, bassi: 1, bassV: 1, bassIV: 1, I: 6, II: 0, majIII: 0, miniii: 1, IV: 2, V: 2, VI: 0, majVII: 0, minvii: 1, VIII: 0, lownoise: 0, midnoise: 1, highnoise: 0, noise:0, buzz: 0 },
  { lowi: 0, bassi: 1, bassV: 1, bassIV: 0, I: 6, II: 0, majIII: 0, miniii: 1, IV: 0, V: 1, VI: 0, majVII: 0, minvii: 0, VIII: 0, lownoise: 0, midnoise: 1, highnoise: 0, noise:0, buzz: 0 },
];
...
const rawsoundfileweightseeds = [ ["monksfromouterspacecistern_a",4,toneweights[2]], ["monksfromouterspacecistern_b",2,toneweights[2]], ["monksfromouterspacecistern_c",2,toneweights[0]], ["monksfromouterspacecistern_d",2,toneweights[0]], ["monksfromouterspacecistern_e",2,toneweights[0]], ["monksfromouterspacecistern_f",1,toneweights[0]], ["monksfromouterspacecistern_g",1,toneweights[0]], ["monksfromouterspacecistern_h",1,toneweights[0]], ["monksfromouterspacecistern_i",1,toneweights[0]], ["monksfromouterspacecistern_j",1,toneweights[0]] ];
...
const tonepads = () => { return tools.randominteger(0,280)/100 };
...
soxstr = soxstr + [...Array(nthreads).keys()].reduce( (threadstr,j1) => {
  ...
  sox -M "|sox -v 0.7 ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}.mp3 -c1 -p pad ${threadpads()} 0 norm -4" "|sox -v 0.7 ${instrument}_twist_000_thread_${(nthreads-j1-1).toString().padStart(3, "0")}.mp3 -c1 -p norm -4" ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_${(nthreads-j1-1).toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 ${mcompandstr};
  sox -M "|sox -v 0.7 ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}.mp3 -c1 -p pad ${threadpads()} 0 norm -4" "|sox -v 0.7 ${instrument}_twist_000_thread_${(nthreads-j1-1).toString().padStart(3, "0")}.mp3 -c1 -p norm -4" ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_${(nthreads-j1-1).toString().padStart(3, "0")}_reverb.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 ${reverbstr} ${mcompandstr};
  ...
  sox -M "|sox -v 0.7 ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_echo.mp3 -c1 -p pad ${threadpads()} 0 norm -4" "|sox -v 0.7 ${instrument}_twist_000_thread_${(nthreads-j1-1).toString().padStart(3, "0")}_echo.mp3 -c1 -p norm -4" ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_${(nthreads-j1-1).toString().padStart(3, "0")}_echo.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 ${mcompandstr};
  sox -M "|sox -v 0.7 ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_echo.mp3 -c1 -p pad ${threadpads()} 0 norm -4" "|sox -v 0.7 ${instrument}_twist_000_thread_${(nthreads-j1-1).toString().padStart(3, "0")}_echo.mp3 -c1 -p norm -4" ${instrument}_twist_000_thread_${j1.toString().padStart(3, "0")}_${(nthreads-j1-1).toString().padStart(3, "0")}_echo_reverb.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 ${reverbstr} ${mcompandstr};`;
