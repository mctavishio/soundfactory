...
let bendcatalog = rawsoundfiles.reduce( (catalog, rawsoundfile) => {
  ...
  catalog[rawsoundfile] = [...Array(nthreads).keys()].reduce( (threads,j) => {
    ...
    //with echo
    threads.push( [ tones, threadstr + " " + rawsoundfile + "_bendthread_" + j.toString().padStart(3, "0") + ".mp3 echos " + echos[(j+1)%echos.length] + " norm -2 silence 1 0.1 1% -1 0.1 1%"  ] );
    //no echo
...
nextsteps = nextsteps + rawsoundfiles.reduce( (nextstepstr,file) => {
  nextstepstr = nextstepstr + `
    sox -m ${file}_thread_*.mp3 ${file}_harmonictwist_all.mp3 fade 0 -0 28 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801;
    sox -m ${file}_bendthread_*.mp3 ${file}_bendtwist_all.mp3 fade 0 -0 28 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801;
    sox -m ${file}*thread_*.mp3 ${file}_twist_all.mp3 fade 0 -0 28 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801;`
...
nextsteps = nextsteps + rawsoundfiles.reduce( (nextstepstr,file1) => {
  rawsoundfiles.forEach( file2 => {
    nextstepstr = nextstepstr + `
    sox -M "|sox  -v 0.8 ${file1}_harmonictwist_all.mp3 -c1 -p pad 1.3 0 norm -2" "|sox -v 0.8 ${file2}_harmonictwist_all.mp3 -c1 -p norm -2" ${file1}_${file2}_harmonictwist_all.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2 silence 1 0.1 1% -1 0.1 1%;
    sox -M "|sox  -v 0.8 ${file1}_bendtwist_all.mp3 -c1 -p pad 1.4 0 norm -2" "|sox -v 0.8 ${file2}_bendtwist_all.mp3 -c1 -p norm -2" ${file1}_${file2}_bendtwist_all.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2 silence 1 0.1 1% -1 0.1 1%;
    sox -M "|sox  -v 0.8 ${file1}_harmonictwist_all.mp3 -c1 -p pad 1.8 0 norm -2" "|sox -v 0.8 ${file2}_bendtwist_all.mp3 -c1 -p norm -2" ${file1}_${file2}_twist_all.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2 silence 1 0.1 1% -1 0.1 1%;`;
    [...Array(Math.floor(nthreads/4)).keys()].forEach( j => {
      let k1 = tools.randominteger(0,nthreads);
      let k2 = tools.randominteger(0,nthreads);
      nextstepstr = nextstepstr + `
    sox -M "|sox  -v 0.8 ${file1}_thread_${k1.toString().padStart(3, "0")}.mp3 -c1 -p pad 1.3 0 norm -2" "|sox -v 0.8 ${file2}_thread_${k2.toString().padStart(3, "0")}.mp3 -c1 -p norm -2" ${file1}_${file2}_threads_${k1.toString().padStart(3, "0")}_${k2.toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801 silence 1 0.1 1% -1 0.1 1%;
    sox -M "|sox  -v 0.8 ${file1}_bendthread_${k2.toString().padStart(3, "0")}.mp3 -c1 -p pad 1.4 0 norm -2" "|sox -v 0.8 ${file2}_bendthread_${k1.toString().padStart(3, "0")}.mp3 -c1 -p norm -2" ${file1}_${file2}_bendthreads_${k2.toString().padStart(3, "0")}_${k1.toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801 silence 1 0.1 1% -1 0.1 1%;
    sox -M "|sox  -v 0.8 ${file1}_thread_${k2.toString().padStart(3, "0")}.mp3 -c1 -p pad 1.4 0 norm -2" "|sox -v 0.8 ${file2}_bendthread_${k1.toString().padStart(3, "0")}.mp3 -c1 -p norm -2" ${file1}_${file2}_thread_bendthread_${k2.toString().padStart(3, "0")}_${k1.toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 gain -4 sinc -n 29 -b 100 8000 mcompand "0.005,0.1 -47,-40,-34,-34,-17,-33" 100 "0.003,0.05 -47,-40,-34,-34,-17,-33" 400 "0.000625,0.0125 -47,-40,-34,-34,-15,-33" 1600 "0.0001,0.025 -47,-40,-34,-34,-31,-31,-0,-30" 6400 "0,0.025 -38,-31,-28,-28,-0,-25" gain 15 highpass 22 highpass 22 sinc -n 255 -b 16 -17500 gain 8 lowpass -1 17801 silence 1 0.1 1% -1 0.1 1%;`
    });
  })
  return nextstepstr;
}, "");
