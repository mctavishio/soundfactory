...
nextsteps = nextsteps + rawsoundfiles.reduce( (nextstepstr,file) => {
  nextstepstr = nextstepstr + `
    sox -m ${file}_thread_*.mp3 ${file}_harmonictwist_all.mp3 fade 0 -0 28 norm -2;
    sox -m ${file}_bendthread_*.mp3 ${file}_bendtwist_all.mp3 fade 0 -0 28 norm -2;
    sox -m ${file}*thread_*.mp3 ${file}_twist_all.mp3 fade 0 -0 28 norm -2;
...
nextsteps = nextsteps + rawsoundfiles.reduce( (nextstepstr,file1) => {
  rawsoundfiles.forEach( file2 => {
    nextstepstr = nextstepstr + `
    sox -M "|sox  -v 0.8 ${file1}_harmonictwist_all_fm.mp3 -c1 -p pad 1.3 0 norm -2" "|sox -v 0.8 ${file2}_harmonictwist_all_fm.mp3 -c1 -p norm -2" ${file1}_${file2}_harmonictwist_all_fm.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2;
    sox -M "|sox  -v 0.8 ${file1}_bendtwist_all_fm.mp3 -c1 -p pad 1.4 0 norm -2" "|sox -v 0.8 ${file2}_bendtwist_all_fm.mp3 -c1 -p norm -2" ${file1}_${file2}_bendtwist_all_fm.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2;
    sox -M "|sox  -v 0.8 ${file1}_harmonictwist_all_fm.mp3 -c1 -p pad 1.8 0 norm -2" "|sox -v 0.8 ${file2}_bendtwist_all_fm.mp3 -c1 -p norm -2" ${file1}_${file2}_twist_all_fm.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2;`;
    [...Array(Math.floor(nthreads/4)).keys()].forEach( j => {
      let k1 = tools.randominteger(0,nthreads);
      let k2 = tools.randominteger(0,nthreads);
      nextstepstr = nextstepstr + `
    sox -M "|sox  -v 0.8 ${file1}_thread_${k1.toString().padStart(3, "0")}.mp3 -c1 -p pad 1.3 0 norm -2" "|sox -v 0.8 ${file2}_thread_${k2.toString().padStart(3, "0")}.mp3 -c1 -p norm -2" ${file1}_${file2}_threads_${k1.toString().padStart(3, "0")}_${k2.toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2;
    sox -M "|sox  -v 0.8 ${file1}_bendthread_${k2.toString().padStart(3, "0")}.mp3 -c1 -p pad 1.4 0 norm -2" "|sox -v 0.8 ${file2}_bendthread_${k1.toString().padStart(3, "0")}.mp3 -c1 -p norm -2" ${file1}_${file2}_bendthreads_${k2.toString().padStart(3, "0")}_${k1.toString().padStart(3, "0")}.mp3 remix 1v0.7,2v0.3 1v0.3,2v0.7 norm -2;`
    });
  })
  return nextstepstr;
}, "");
